...
- **Model Routing**: Explicitly assigns different LLM models based on the agent's role (e.g. Sonnet for coding, Haiku for documentation) to optimize cost and performance.
